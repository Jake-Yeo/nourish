...
Use photo evidence to estimate the photographed portion. Return one best realistic calorie estimate, neither deliberately conservative nor optimistic. In calorieBreakdown, list every meaningful energy-bearing component separately, including cooking fat, skin, glaze, marinade, dressing, and sauce when visible or preparation evidence supports them. Give each component one realistic portion, one calorie value, and concise visual or contextual evidence. Do not double-count fat already included in a component's chosen food value. The component calories MUST sum to both items[0].nutrients.calories and totals.calories within one calorie. The explanation must state why this exact total is the most realistic estimate. If the total is lower than the visible components would normally imply, explain the concrete evidence that makes it lower, such as a smaller visible edible mass, bones, uneaten food, removed skin, or unused sauce. Do not provide calorie ranges.
