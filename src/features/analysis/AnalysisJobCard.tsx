...
export function AnalysisJobCard({ job, onOpen }: { job: MealAnalysisJob; onOpen: () => void }) {
  ...
  return <button className="w-full min-w-0 cursor-pointer rounded-card text-left focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-primary/20" onClick={onOpen} aria-label={`Open ${title} analysis`}>
