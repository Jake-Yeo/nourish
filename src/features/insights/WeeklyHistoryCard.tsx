...
export function WeeklyHistoryCard(props: WeeklyHistoryCardProps) {
  const { caloriesByDate, change, endingDateKey, endDate, nutritionData, startDate } = props
  ...
  return <Card className="px-content py-control-wide" padding="none" variant="flat">
    ...
    <WeeklyHistorySummary averageCalories={summary.averageCalories} averageProtein={summary.averageProtein} changeLabel={getChangeLabel(change.loggedDays, change.pounds)} />
