...
export default function App() {
  ...
  return <div className="grid h-dvh min-w-80 overflow-hidden bg-canvas font-sans text-ink antialiased desktop:grid-cols-app-shell">
    ...
    {dialogs.photoMealType && <PhotoMealModal defaultMealType={dialogs.photoMealType} initialSource={dialogs.photoMealSeed ?? undefined} selectedDateKey={navigation.selectedDateKey} onClose={dialogs.closePhotoMeal} onQueued={job => { setQueuedAnalysisJob(job); showToast('Meal analysis queued'); navigation.setActiveView('analysis') }} />}
